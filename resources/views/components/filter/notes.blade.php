...
<form method="get" action="{{ route('note.index') }}" data-filterline__sandwich>
    ...
    <div class="mmot-filterline-justify mmot-filterline__sandwich__list hide" data-filterline_sandwich_child="filter_planing">
        <div class="mmot-filterline">
            <div class="mmot-filterline">
                ...
                <div class="mmot-filterline__one" data-input_clear_content>
                    <input type="text" name="phrase" id="phrase" class="form-control" value="{{ request('phrase') }}" placeholder="{{ __('Фраза') }}" data-input_clear>
                </div>
            </div>
        </div>
        ...
        <div class="mmot-filterline">
            <div class="mmot-filterline__one">
                <a href="{{ route('note.index') }}" type="button" class="btn btn-secondary w block">{{ __('Сбросить') }}</a>
            </div>
